/*
initMenu: The first menu to be selected and started.
*/
...
const customTheme = {
  ...
  "menu.activeIcon.color": "#3498db", // Active icon color
  "menu.disabledIcon.color": "#7f8c8d", // Disabled icon color
  "menu.hoverIcon.color": "#ecf0f1", // Hover icon color
  "submenu.backgroundColor": "#2c3e50", // Submenu background
  "submenu.partition.color": "#ecf0f1", // Divider color
  "submenu.normalLabel.color": "#ecf0f1", // Label text color
  "submenu.activeLabel.color": "#3498db", // Active label color
};
